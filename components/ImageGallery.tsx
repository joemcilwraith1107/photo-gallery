        ...
        <DialogContent className="max-w-[90vw] max-h-[90vh] h-auto w-auto p-0 overflow-hidden" hidden>
          {selectedImage && (
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <button
                onClick={closeModal}
                className="absolute top-2 right-2 p-2 bg-black bg-opacity-50 rounded-full text-white hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-white"
